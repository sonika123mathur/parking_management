        ...
        <div class="row items-push">
            ...
            <div class="col-sm-4 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    <li><a href="{{route('admin.users.index')}}">Roles</a></li>
                    <li class="link-effect">Create Role</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="block">
                    <div class="block-content block-content-narrow">
                        <form class="form-horizontal push-10-t add-role-form" action="{{route('admin.roles.store')}}"
                              method="post">
                            @csrf
                                ...
                                <div class="col-sm-12">
                                    <div class="form-material form-material-primary">
                                        <input class="form-control" type="text" id="user-name"
                                               name="name" placeholder="Role Name" value="{{old('name')}}" required>
                            ...
                            <div class="form-group{{ $errors->has('display_name') ? ' has-error' : '' }}">
                                <div class="col-sm-12">
                                    <div class="form-material form-material-primary">
                                        <input class="form-control" type="text" id="user-display_name"
                                               name="display_name" placeholder="Role Name" value="{{old('display_name')}}" required>
                                        <label for="user-display_name">Role Display Name</label>
                                    </div>
                                    @if ($errors->has('display_name'))
                                        <div id="user-display_name-error"
                            ...
                            {{--<div class="form-group{{ $errors->has('module') ? ' has-error' : '' }}">
                                <div class="col-sm-12">
                                    <div class="form-material form-material-primary">
                                        <input class="form-control" type="text" id="user-module"
                                               name="module" placeholder="Role Name" value="{{old('module')}}" required>
                                        <label for="user-module">Module Name</label>
                                    </div>
                                    @if ($errors->has('module'))
                                        <div id="user-module-error"
                                             class="help-block animated fadeInDown">{{ $errors->first('module') }}</div>
                                    @endif
