...
@section('maincontent')
    ...
    <div class="content bg-image overflow-hidden"
         style="background-image: url('{{asset('admin_assets/img/photos/photo3@2x.jpg')}}');">
    ...
    <div class="content bg-white border-b">
        <div class="row items-push text-uppercase">
            <div class="col-xs-6 col-sm-3">
                ...
                <a class="h2 font-w300 text-primary animated flipInX" href="javascript://">300</a>
            </div>
            <div class="col-xs-6 col-sm-3">
                <div class="font-w700 text-gray-darker animated fadeIn">Product Sales</div>
                <div class="text-muted animated fadeIn"><small><i class="si si-calendar"></i> This Month</small></div>
                <a class="h2 font-w300 text-primary animated flipInX" href="javascript://">8,790</a>
            </div>
            <div class="col-xs-6 col-sm-3">
                ...
                <a class="h2 font-w300 text-primary animated flipInX" href="javascript://">$ 93,880</a>
            </div>
            <div class="col-xs-6 col-sm-3">
                <div class="font-w700 text-gray-darker animated fadeIn">Average Sale</div>
                <div class="text-muted animated fadeIn"><small><i class="si si-calendar"></i> All Time</small></div>
                <a class="h2 font-w300 text-primary animated flipInX" href="javascript://">$ 270</a>
            </div>
        </div>
    </div>
    <!-- END Stats -->
                            ...
                            <li>
                                ...
                                <div class="list-timeline-content">
                                    ...
                                    <ul class="nav-users push-10-t push">
                                        <li>
                                            <a href="javascript://">
                                                <img class="img-avatar" src="{{asset("admin_assets/")}}/img/avatars/avatar13.jpg" alt="">
                                        ...
                                        <li>
                                            <a href="javascript://">
                                                <img class="img-avatar" src="{{asset("admin_assets/")}}/img/avatars/avatar7.jpg" alt="">
                                        ...
                                        <li>
                                            <a href="javascript://">
                                                <img class="img-avatar" src="{{asset("admin_assets/")}}/img/avatars/avatar12.jpg" alt="">
                                                <i class="fa fa-circle text-danger"></i> George Stone
            ...
            <div class="col-lg-4">
                ...
                <div class="content-grid">
                    <div class="row">
                        <div class="col-xs-12">
                            <!-- Author of the Month -->
                            <a class="block block-link-hover2" href="javascript://">
                                <div class="block-header">
                                    <h3 class="block-title text-center">Author of the Month</h3>
                                </div>
                                <div class="block-content block-content-full text-center bg-image" style="background-image: url('{{asset("admin_assets/img/photos/photo2.jpg")}}');">
                                    <div>
                                        <img class="img-avatar img-avatar96 img-avatar-thumb" src="{{asset("admin_assets/")}}/img/avatars/avatar1.jpg" alt="">
                                    </div>
                                    <div class="h5 text-white push-15-t push-5">Tiffany Kim</div>
...
@section('custom-styles')
    ...
    <!-- Page JS Plugins CSS -->
    <link rel="stylesheet" href="{{asset("admin_assets/js/plugins/slick/slick.min.css")}}">
    <link rel="stylesheet" href="{{asset("admin_assets/js/plugins/slick/slick-theme.min.css")}}">
@endsection
@section('custom-js')
    ...
    <script src="{{asset("admin_assets/js/pages/base_pages_dashboard.js")}}"></script>
    <script>
        jQuery(function () {
