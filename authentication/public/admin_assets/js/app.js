...
var App = function () {
    ...
    var uiYearCopy = function () {
        ...
        if ($date.getFullYear() === 2019) {
            ...
            $yearCopy.html('2019-' + $date.getFullYear().toString().substr(2, 2));
        }
    };
    ...
    var uiHelperDatatable = function (className) {
    ...
    var uiFormValidation = function (formClass) {
    ...
    /**
     * sweetalert, a jquery plugin.
     */
    var onSubmitSweetAlert = function (data, className) {
    ...
    return {
        ...
        initFormValidation: function ($className) {
            uiFormValidation($className);
        },
        initOnSubmitSweetAlert: function ($data, $className) {
            onSubmitSweetAlert($data, $className);
        },
        initDataTable: function ($className) {
            bsDataTables();
            uiHelperDatatable($className);
        },
